...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("\nProject Leads:\nBrent Bailey\nArnab Chakravarty\n\nStory:\nIan McNeely\nBrent Bailey\n\nDesign:\nLifei Wang\nArnab Chakravarty \nHenry Baum \n\nProgramming:\nBrent Bailey\nHenry Baum\n\nML Development:\nLifei Wang\n\nMusic:\nMatt Ross\n\nDevelopment was supported by a Mozilla Creative Media Award.\nAI images created with Stable Diffusion, finetuned by a paid artist on a mix of custom-made and open-source images. \nA full list of assets used under a Creative Commmons license can be found {a=https://docs.google.com/document/d/1TI6jKvw5lXMbCfFNyeNMKES9YxGqImPAZpJJQgcVVV0/edit?usp=sharing}here{/a}.\nCode for the game is available {a=https://github.com/hobg0blin/dataville}here{/a} under a Mozilla Public License.\n\nMade with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t] \n\nSpecial thanks to our playtesters: \nKate Mason\nMaarvi Khawaja\nJames Hosken\nAugust Luhrs\nSchuyler Devos\nCasey Conchinha\nDustin Long\nRyan Wagahoff\nCalder Hussman\nVictoria Levchenko\nAndrés Cuervo\nJeremy Lawrence\nAnd everyone at Wonderville Playtest night.\n\nThanks for playing!")
